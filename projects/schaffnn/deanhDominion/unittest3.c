...
* Description: This test suite tests the ambassadorRe function located in the dominion.c file provided by deanh.
****************************************************************/
