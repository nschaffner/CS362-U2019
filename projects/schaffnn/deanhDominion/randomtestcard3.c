...
* Description: This random test suite tests the tributeRe function located in the dominion.c file provided by deanh.
****************************************************************/
...
int main() {
    ...
    for(int i = 0; i < 1000000; i++){
        ...
        tributeRe(&G, currentPlayer, tributeRevealedCards);
