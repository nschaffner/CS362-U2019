...
* Description: This random test suite tests the minionCase function located in the dominion.c file.
****************************************************************/
...
int main() {
    ...
    for(int i = 0; i < 100000; i++){
        ...
        minionCase(playerChoice1, playerChoice2, &G, cardPos, currentPlayer);
